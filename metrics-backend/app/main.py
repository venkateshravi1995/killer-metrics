"""FastAPI application entrypoint for the metrics backend."""
...
app = FastAPI(title="Metric Killer API", lifespan=lifespan)
...
async def database_config_error_handler(
    ...
    return JSONResponse(
        status_code=500,
        content={"detail": "Database configuration error."},
    )
